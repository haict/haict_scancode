...
public class CUS302 extends CUSRequest<CUS302.DataImp> {
	@XStreamOmitField
	private static final CUSMessage type = CUSMessage.CUS_302;
	static {
		CUSBeanFactory.getInstance().register(type, new CUS302());
	}
	...
	public static class DataImp extends Data{
		...
		private Date ngayCT;
		/*@XStreamAlias("Ma_NT")
		private String maNT = "VND";
		@XStreamAlias("Ty_Gia")
		private String tyGia = "1";*/
		...
		public void setMaNTK(String string) {
			this.maNTK = string;
		}
	...
	public static class GNTCT implements Serializable{
		...
		public int gettTButToan() {
			return tTButToan;
		}
		public void settTButToan(int tTButToan) {
	...
	public CUSBeanImp<CUS302.DataImp> init() {
		CUS302 bean = new CUS302();

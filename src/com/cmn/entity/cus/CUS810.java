...
public class CUS810 extends CUSRequest<CUS810.DataImp> {
	@XStreamOmitField
	private static final CUSMessage type = CUSMessage.CUS_810;

	static {
		CUSBeanFactory.getInstance().register(type, new CUS810());
	}

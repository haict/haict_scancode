...
public class CUS805 extends CUSRequest<CUS805.DataImp>{

	@XStreamOmitField
	private static final CUSMessage type = CUSMessage.CUS_805;
	static {
		CUSBeanFactory.getInstance().register(type, new CUS805());
	}
	...
	@Override
	public CUSBeanImp<CUS805.DataImp> init() {
		CUS805 bean = new CUS805();

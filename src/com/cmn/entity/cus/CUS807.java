...
public class CUS807 extends CUSRequest<CUS807.DataImp> {
	@XStreamOmitField
	private static final CUSMessage type = CUSMessage.CUS_807;
	static {
		CUSBeanFactory.getInstance().register(type, new CUS807());
	}
	
	public CUSBeanImp<CUS807.DataImp> init() {
		CUS807 bean = new CUS807();

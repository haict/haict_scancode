...
import com.cmn.entity.cus.CUS804.Transactions;
...
public class CUS854 extends CUSResponse<CUS854.DataImp>{
	
	@XStreamOmitField
	private static final CUSMessage type = CUSMessage.CUS_854;
	static {
		CUSBeanFactory.getInstance().register(type, new CUS854());
	}
	...
	@Override
	public CUSBean init() {
		CUS854 bean = new CUS854();
		bean.data = new CUS854.DataImp();
		return bean;
	}

...
public class CUS859 extends CUSResponse<CUS859.DataImp> {
	@XStreamOmitField
	private static final CUSMessage type = CUSMessage.CUS_859;

	static {
		CUSBeanFactory.getInstance().register(type, new CUS859());
	}

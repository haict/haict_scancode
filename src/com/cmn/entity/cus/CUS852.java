...
import com.cmn.entity.cus.CUS851.DataImp;
import com.cmn.entity.cus.CUS851.GntCt;
import com.cmn.entity.cus.CUS851.ToKhaiCt;
import com.cmn.entity.cus.CUS851.Transactions;
...
public class CUS852 extends CUSResponse<CUS852.DataImp>{
	
	@XStreamOmitField
	private static final CUSMessage type = CUSMessage.CUS_852;
	static {
		CUSBeanFactory.getInstance().register(type, new CUS852());
	}
	...
	@Override
	public CUSBean init() {
		CUS852 bean = new CUS852();
		bean.data = new CUS852.DataImp();
		return bean;
	}

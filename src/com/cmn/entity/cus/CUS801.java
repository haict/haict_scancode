...
public class CUS801 extends CUSRequest<CUS801.DataImp> {
	
	@XStreamOmitField
	private static final CUSMessage type = CUSMessage.CUS_801;
	static {
		CUSBeanFactory.getInstance().register(type, new CUS801());
	}
	
	@XStreamAlias("Error")
	private Error error;

	public CUSBeanImp<CUS801.DataImp> init() {
		CUS801 bean = new CUS801();

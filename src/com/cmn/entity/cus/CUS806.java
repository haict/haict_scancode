...
public class CUS806 extends CUSRequest<CUS806.DataImp>{

	@XStreamOmitField
	private static final CUSMessage type = CUSMessage.CUS_806;
	static {
		CUSBeanFactory.getInstance().register(type, new CUS806());
	}
	...
	@Override
	public CUSBeanImp<CUS806.DataImp> init() {
		CUS806 bean = new CUS806();

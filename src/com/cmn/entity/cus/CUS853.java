...
public class CUS853 extends CUSResponse<CUS853.DataImp>{
	
	@XStreamOmitField
	private static final CUSMessage type = CUSMessage.CUS_853;
	static {
		CUSBeanFactory.getInstance().register(type, new CUS853());
	}
	...
	@Override
	public CUSBean init() {
		CUS853 bean = new CUS853();
		bean.data = new CUS853.DataImp();
		return bean;
	}
	...
	public static class Transactions {
		...
		@XStreamImplicit(itemFieldName="NguoiNopTien")
		private List<NguoiNopTien> nguoiNopTien = new ArrayList<NguoiNopTien>();

		@XStreamImplicit(itemFieldName="ThongTin_NopTien")
		private List<ThongTinNopTien> thongTinNopTien = new ArrayList<ThongTinNopTien>();
		

		@XStreamImplicit(itemFieldName="ChungTu_CT")		
		private List<ChungTuCT> chungTuCT = new ArrayList<ChungTuCT>();
		
		@XStreamImplicit(itemFieldName="NguoiNopTien")
		private List<TaiKhoanNopTien> taiKhoanNopTien = new ArrayList<TaiKhoanNopTien>();
		...
		public List<NguoiNopTien> getNguoiNopTien() {
			return nguoiNopTien;
		}

		public void setNguoiNopTien(List<NguoiNopTien> nguoiNopTien) {
		...
		public List<ChungTuCT> getChungTuCT() {
			return chungTuCT;
		}

		public void setChungTuCT(List<ChungTuCT> chungTuCT) {
			this.chungTuCT = chungTuCT;
		}

		public List<TaiKhoanNopTien> getTaiKhoanNopTien() {
			return taiKhoanNopTien;
		}

		public void setTaiKhoanNopTien(List<TaiKhoanNopTien> taiKhoanNopTien) {

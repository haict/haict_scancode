...
public class TTDTPortalSoapProxy implements bgw.services.hq247.TTDTPortalSoap {
  private String _endpoint = null;
  private bgw.services.hq247.TTDTPortalSoap tTDTPortalSoap = null;
  ...
  private void _initTTDTPortalSoapProxy() {
    try {
      tTDTPortalSoap = (new bgw.services.hq247.TTDTPortalLocator()).getTTDTPortalSoap();
  ...
  public bgw.services.hq247.TTDTPortalSoap getTTDTPortalSoap() {
    if (tTDTPortalSoap == null)
      _initTTDTPortalSoapProxy();

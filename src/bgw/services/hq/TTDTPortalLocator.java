...
public class TTDTPortalLocator extends org.apache.axis.client.Service implements bgw.services.hq.TTDTPortal {
    ...
    private java.lang.String TTDTPortalSoap_address = HQConstant.BGW_HQ_TTDT;
    ...
    public bgw.services.hq.TTDTPortalSoap getTTDTPortalSoap() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
        	System.out.println("Truy van:"+TTDTPortalSoap_address);
    ...
    public bgw.services.hq.TTDTPortalSoap getTTDTPortalSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            bgw.services.hq.TTDTPortalSoapStub _stub = new bgw.services.hq.TTDTPortalSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (bgw.services.hq.TTDTPortalSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                bgw.services.hq.TTDTPortalSoapStub _stub = new bgw.services.hq.TTDTPortalSoapStub(new java.net.URL(TTDTPortalSoap_address), this);
                _stub.setPortName(getTTDTPortalSoapWSDDServiceName());
                return _stub;
            }
        }

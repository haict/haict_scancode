...
public class DCTTDTPortalSoapProxy implements bgw.services.hq.DCTTDTPortalSoap {
  private String _endpoint = null;
  private bgw.services.hq.DCTTDTPortalSoap dCTTDTPortalSoap = null;
  ...
  private void _initDCTTDTPortalSoapProxy() {
    try {
      dCTTDTPortalSoap = (new bgw.services.hq.DCTTDTPortalLocator()).getDCTTDTPortalSoap();
  ...
  public bgw.services.hq.DCTTDTPortalSoap getDCTTDTPortalSoap() {
    if (dCTTDTPortalSoap == null)
      _initDCTTDTPortalSoapProxy();

...
public class DCTTDTPortalLocator extends org.apache.axis.client.Service implements bgw.services.hq.DCTTDTPortal {
    ...
    private java.lang.String DCTTDTPortalSoap_address = HQConstant.BGW_HQ_DCDT;//"https://192.168.1.3/TTDT3/DCTTDTPortal.asmx";
    ...
    public bgw.services.hq.DCTTDTPortalSoap getDCTTDTPortalSoap() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
        	System.out.println("Doi chieu:"+DCTTDTPortalSoap_address);
    ...
    public bgw.services.hq.DCTTDTPortalSoap getDCTTDTPortalSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            bgw.services.hq.DCTTDTPortalSoapStub _stub = new bgw.services.hq.DCTTDTPortalSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (bgw.services.hq.DCTTDTPortalSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                bgw.services.hq.DCTTDTPortalSoapStub _stub = new bgw.services.hq.DCTTDTPortalSoapStub(new java.net.URL(DCTTDTPortalSoap_address), this);
                _stub.setPortName(getDCTTDTPortalSoapWSDDServiceName());
                return _stub;
            }
        }
